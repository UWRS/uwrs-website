...
/* Boilerplate code below, presumably for defining `components` (for routing purpose) */
...
/* Boilerplate code above, presumably for defining `components` (for routing purpose) */
