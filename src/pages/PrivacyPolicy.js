    ...
    <AnimationRevealPage>
      ...
      <Container>
        <ContentWithPaddingXl>
          ...
          <Text>
            <p>Last updated:⠀Sep 09, 2022</p>

            <p>
              When changes are made to this statement, we will publish the updated version on our website.
            </p>
            <p>
              The controller for your personal information is UWRS. The person responsible for data protection is our Webmaster, who can be contacted at:⠀info [at] warwickrobotics [dot] co [dot] uk.
            </p>
            ...
            <ul>
              ...
              <li>
                <strong>Affiliate</strong> means a partner society, institution or sponsor supporting our cause in written agreement.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to UWRS, accessible from https://www.warwickrobotics.co.uk/
              </li>{" "}
              <li>
                <strong>Service</strong> refers to the Website.
              </li>
              <li>
                <strong>Country</strong> refers to: Coventry, United Kingdom
              </li>
              <li>
                <p>
              ...
              <li>
                ...
                through which You can log in or create an account to use the Service.
              </li>
              <li>
                <p>
            ...
            <ul>
              ...
              <li>Address, City, County, Postal code</li> <li>Usage Data</li>
            </ul>
            ...
            <ul>
              ...
              <li>
                ...
                services and events which we offer that are similar to those that you have already signed up for or enquired
            ...
            <p>The Company may share Personal Data for the following purposes:</p>
            ...
            <p>
              ...
              be transferred to — and maintained on — computers located outside of Your town, county, country or
