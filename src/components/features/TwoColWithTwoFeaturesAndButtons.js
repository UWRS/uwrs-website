...
const PrimaryButton = tw(PrimaryButtonBase)`mt-8 md:mt-10 text-sm inline-block mx-auto md:mx-10`;

export default ({
  subheading = "Our Student-Led Teams",
  heading = (
    <>
      The <span tw="text-primary-500">biggest</span> robotics group in Warwickshire.
    </>
  ),
  description = "Proudly enabling robotics for all enthusiasts.",
