...
export default ({
  ...
  description = "We hugely appreciate all the help and advice we receive from our amazing supporters.",
  plans = null,
  ...
  const defaultPlans = [
    {
      ...
      price: ["£49", ".99"],
      oldPrice: "",
      description: "If your contribution is at least ...",
      features: [
        "Small logo",
        "Name on our website for 1 year",
        "A shoutout over our mailing list"],
    ...
    },
    {
      ...
      description: "If your contribution is at least ...",
      features: [
        "Big logo + a short description on our website for 2 years",
        "Small logo on club’s banner — brought to all robotics competitions & fairs",
        "Networking opportunity to hold a promoted tech talk at University of Warwick",
        "A shout-out over our mailing list"
      ],
      url: "https://google.com",
    },
    {
      ...
      description: "If your contribution is at least ...",
      features: [
        "Access to club-wide resume book",
        "Big logo + a medium-length description on our website for 3 years",
        "Big logo on club’s banner — brought to all robotics competitions & fairs",
        "Networking opportunity to hold numerous promoted tech talks at University of Warwick",
        "Arrange design review of ALL our robots + meet ALL project teams",
        "Multiple shoutouts over our mailing list + mentions in public correspondence"
      ],
      url: "https://google.com"
    }
  ];
