...
const Tabtag = tw(motion.div)`mt-6 flex flex-wrap sm:-mr-10 md:-mr-6 lg:-mr-12`;
...
export default ({
   ...
   * as the key and value of the key will be its tag (as an array of objects).
